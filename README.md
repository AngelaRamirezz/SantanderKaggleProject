...
The best model resulted in area under the ROC curve between thw predicted proabbility and the observed target of x. Currently, the best score on the Kaggle Leaderboard is 0.82907.

## Summary 
### Data

#### Preprocessing/Clean up
There were no missing values in the data. However there were a few repeated columns which were droped. 
